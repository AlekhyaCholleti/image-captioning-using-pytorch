...
def load_image(image_path, transform=None):
	...
	if transform is not None:
		image = transform(image)  #shape(3, 224, 224)   #image should be a variable object is it variable here?
...
def main(args):
	...
	sampled_ids = sampled_ids[0].cpu().numpy()  #(1, max_seq_len) --> (max_Seq_length)
